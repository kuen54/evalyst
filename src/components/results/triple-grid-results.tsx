            ...
            >
              ...
              {colValues.map(cv => {
                ...
                return (
                  <GlassThin
                    key={String(cv)}
                    className={`p-2 flex flex-col gap-1.5 overflow-hidden rounded-lg border bg-card text-sm text-card-foreground ${r.status !== "success" ? "border-red-500/40 bg-red-500/10" : ""}`}
