...
function coerceCsvRow(row: Record<string, string>, headers: string[]): Record<string, unknown> {
...
function inferFieldsFromCsv(records: Record<string, unknown>[], headers: string[]): FieldDef[] {
 ...
 */
function detectIdField(records: Record<string, unknown>[], headers: string[]): string | null {
...
function tryParseRecords(text: string, t: TFn): { records: Record<string, unknown>[]; error: string | null } {
